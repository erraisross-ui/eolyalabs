// ─────────────────────────────────────────────────────────────────────────────
// EOLYALABS — EolyaCTA.jsx  |  Framer Code Component
...
// ── Composant principal ───────────────────────────────────────────────────────
export default function EolyaCTA({
    titleLine1      = "Prêt à transformer",
    titleLine2      = "votre biologie ?",
    subtitle        = "Le premier pas est un appel de 30 minutes — gratuit, sans engagement. Vous repartez avec une direction claire, que vous choisissiez de continuer avec nous ou non.",
    ctaLabel        = "Réserver ma consultation",
    ctaUrl          = "https://calendly.com/eolyalabs/30min",
    ctaSubtext      = "Gratuit · 30 min · Zoom ou téléphone",
    legalText       = "Analyses effectuées par nos partenaires privés certifiés (Biron / CDL). Requêtes émises par Eolyalabs. Protocoles à titre informatif et préventif.",
...
addPropertyControls(EolyaCTA, {
    titleLine1:      { type: ControlType.String,  title: "Titre ligne 1",        defaultValue: "Prêt à transformer" },
    titleLine2:      { type: ControlType.String,  title: "Titre ligne 2 (doré)", defaultValue: "votre biologie ?" },
    subtitle:        { type: ControlType.String,  title: "Sous-titre",           defaultValue: "Le premier pas est un appel de 30 minutes — gratuit, sans engagement.", displayTextArea: true },
    ctaLabel:        { type: ControlType.String,  title: "Texte bouton",         defaultValue: "Réserver ma consultation" },
    ctaUrl:          { type: ControlType.String,  title: "URL Calendly",         defaultValue: "https://calendly.com/eolyalabs/30min" },
    ctaSubtext:      { type: ControlType.String,  title: "Micro-texte bouton",   defaultValue: "Gratuit · 30 min · Zoom ou téléphone" },
    legalText:       { type: ControlType.String,  title: "Texte légal",          defaultValue: "Analyses effectuées par nos partenaires privés certifiés (Biron / CDL). Protocoles à titre informatif et préventif.", displayTextArea: true },
    showTrustBadges: { type: ControlType.Boolean, title: "Badges de confiance",  defaultValue: true },
    showLegalLine:   { type: ControlType.Boolean, title: "Ligne légale",         defaultValue: true },
})

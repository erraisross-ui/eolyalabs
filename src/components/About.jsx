            ...
            <div style={{ maxWidth: 1180, margin: "0 auto", position: "relative", zIndex: 1 }}>
                ...
                >
                    <p style={{ fontFamily: sans, fontSize: 10, fontWeight: 600, letterSpacing: "0.22em", textTransform: "uppercase", color: gold, marginBottom: 20 }}>
                        Le duo derrière Eolyalabs
                    </p>
                    <h2 style={{ fontFamily: serif, fontSize: "clamp(36px, 5vw, 58px)", fontWeight: 400, color: white, lineHeight: 1.1, marginBottom: 18 }}>
                        Deux expertises.<br /><em style={{ fontStyle: "normal", color: gold }}>Une mission commune.</em>
                    </h2>
                    <div style={{ width: 40, height: 1, background: "rgba(201,169,110,0.4)", margin: "0 auto 28px" }} />
                    <p style={{ fontFamily: sans, fontSize: 16, fontWeight: 300, color: steelLt, lineHeight: 1.9, maxWidth: 580, margin: "0 auto 14px" }}>
                    ...
                    <p style={{ fontFamily: sans, fontSize: 16, fontWeight: 300, color: steelLt, lineHeight: 1.9, maxWidth: 580, margin: "0 auto" }}>
                        Abdessamad et Eolie ont uni leurs formations, leur expérience clinique et leur passion pour la biologie humaine pour créer une clinique différente — où chaque décision est justifiée par vos données, pas par des généralités de population.
                    </p>
                </motion.div>
